...
const config = {
  title: 'InsightAgent',
  tagline: 'Agentic intelligence for enterprise data',
  favicon: 'img/insightagent_logo.png',

  // Set the production url of your site here
  url: 'https://liujincheng-ai.github.io',
  ...
  organizationName: 'liujincheng-ai', // Usually your GitHub org/user name.
  projectName: 'InsightAgent', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        logo: {
          ...
          src: 'img/insightagent_logo.png',
          srcDark: 'img/insightagent_logo_white.png',
          href: "/"
        },
        ...
        items: [
          ...
          {
            href: 'https://github.com/liujincheng-ai/InsightAgent/discussions',
            position: 'right',
            label: 'Community',
          },
          ...
          {
            href: 'https://github.com/liujincheng-ai/InsightAgent/releases',
            position: 'right',
            label: "Releases",
          },
          {
            href: 'https://github.com/liujincheng-ai/InsightAgent',
            position: 'right',
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} InsightAgent`,
      },
      prism: {
