# InsightAgent V0.8.0 — Paradigm Shift: AI + Data Driven Analytics Experience
...
InsightAgent V0.8.0 introduces a self-driven AI Data Assistant that autonomously handles the entire analytics pipeline:
...
You no longer need to know which table your data lives in, nor write Python scripts for intermediate data cleaning. Simply state your business objective, and the **InsightAgent AI Data Assistant** will take care of everything.
...
- 🚀 **One-Click Setup Script** — A new streamlined installation script to get InsightAgent up and running faster than ever

## Features

### ✨ Agentic Data Analytics Engine

The InsightAgent AI Data Assistant can now autonomously orchestrate an entire execution pipeline around your analysis goals, moving beyond the limitations of traditional single-turn conversations to deliver a brand-new autonomous data analytics experience:
...
We provide multiple new streamlined installation scripts to get InsightAgent up and running faster.
...
# Start InsightAgent
cd ~/.dbgpt/InsightAgent && uv run dbgpt start webserver --config ~/.dbgpt/configs/<profile>.toml
```
...
For detailed installation instructions, see the [Installation Guide](https://liujincheng-ai.github.io/InsightAgent/docs/next/installation/).
...
👉 [Browse the New Documentation](https://liujincheng-ai.github.io/InsightAgent/docs/next/overview/)

## Other Improvements

- Add MiniMax Provider support ([#2989](https://github.com/liujincheng-ai/InsightAgent/pull/2989))
- Fix React parser handling of vis-thinking blocks ([#2996](https://github.com/liujincheng-ai/InsightAgent/pull/2996))
- README and documentation updates ([#2991](https://github.com/liujincheng-ai/InsightAgent/pull/2991))
...
- [Docker Quick Deploy](https://liujincheng-ai.github.io/InsightAgent/docs/next/installation/docker/)
