...
The call of multi-model services is compatible with the OpenAI interface, and the models deployed in InsightAgent can be directly called through the OpenAI SDK.
