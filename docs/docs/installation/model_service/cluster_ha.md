...
-- For deploy model cluster of InsightAgent(StorageModelRegistry)
...
Congratulations! You have successfully deployed a high availability cluster of InsightAgent.


## Deploy High Availability Cluster With Docker Compose

If your want know more about deploying a high availability InsightAgent cluster, you can see
...
Here we will show you how to deploy a high availability cluster of InsightAgent with docker compose.
