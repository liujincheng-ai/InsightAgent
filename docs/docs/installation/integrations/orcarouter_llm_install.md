...
### This section describes how to use the OrcaRouter provider with InsightAgent.
...
3. Use the `configs/dbgpt-proxy-orcarouter.toml` configuration when starting InsightAgent.

### You can look up models at [https://www.orcarouter.ai/models](https://www.orcarouter.ai/models)

### Or you can use docker/base/Dockerfile to run InsightAgent with OrcaRouter:
