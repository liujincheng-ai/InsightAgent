...
Vertica is an analytical SQL data warehouse supported by InsightAgent through the native
...
Prepare a Vertica instance and start the InsightAgent webserver:
