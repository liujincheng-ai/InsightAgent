...
OceanBase is a distributed SQL database supported by InsightAgent through the native
...
Prepare an OceanBase instance and start the InsightAgent webserver:
