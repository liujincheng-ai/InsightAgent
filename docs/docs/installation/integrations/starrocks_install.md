...
StarRocks is a high-performance analytical database supported by InsightAgent through
...
Prepare a StarRocks instance and start the InsightAgent webserver:
