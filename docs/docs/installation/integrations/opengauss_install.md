...
openGauss is an open-source relational database supported by InsightAgent through the
...
Prepare an openGauss instance and start the InsightAgent webserver:
