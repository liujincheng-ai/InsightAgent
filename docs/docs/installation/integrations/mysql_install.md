...
MySQL is a widely used open-source relational database system. InsightAgent includes a
...
Prepare a MySQL service and database, then start the InsightAgent webserver:
