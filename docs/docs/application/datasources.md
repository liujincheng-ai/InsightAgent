...
The InsightAgent data source module is designed to manage the structured and semi-structured data assets of an enterprise, connect databases, data warehouses, data lakes, etc. to the InsightAgent framework, and quickly build data-based intelligent applications and large models. Currently, InsightAgent supports some common data sources and also supports custom extensions.
