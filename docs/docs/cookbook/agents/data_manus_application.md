...
为了方便用户进一步了解InsightAgent社区多智能体应用构建过程，方便对Data_manus中各个子Agent进行优化，我们在examples目录下提供多个开发示例以供学习：
**db_create**
...
async def main():
    # 多个Excel文件路径
    excel_files = [
        "/home/me/InsightAgent/examples/test_files/employer_info.xlsx",
        "/home/me/InsightAgent/examples/test_files/project_info.xlsx",
        # 可以添加更多Excel文件路径
