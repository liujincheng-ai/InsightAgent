...
read_when:
  ...
  - InsightAgent starts inconsistently, the UI is blank, or models fail to load
---

# Troubleshooting

Common issues and solutions when working with InsightAgent.
...
1. **Search existing issues**: [GitHub Issues](https://github.com/liujincheng-ai/InsightAgent/issues)
2. **Ask the community**: [GitHub Discussions](https://github.com/liujincheng-ai/InsightAgent/discussions)
3. **Join Slack**: [InsightAgent Slack](https://join.slack.com/t/slack-inu2564/shared_invite/zt-29rcnyw2b-N~ubOD9kFc7b7MDOAM1otA)
