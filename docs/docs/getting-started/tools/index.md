...
sidebar_position: 0
title: Tools & Plugins
summary: "How InsightAgent extends agents with MCP, dbgpts, and AWEL Flow"
read_when:
  - You want to add tools or external integrations to InsightAgent
  - You want to understand the difference between MCP, dbgpts, and AWEL Flow
---

# Tools & Plugins

Extend InsightAgent with external tools, community packages, and visual workflow building.
...
InsightAgent supports three main extension mechanisms:
...
Agents in InsightAgent can use tools to:
