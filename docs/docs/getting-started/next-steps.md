...
sidebar_position: 99
title: Next Steps
summary: "Where to go after the first successful InsightAgent setup"
read_when:
...
| Resource | Link |
|---|---|
| GitHub Repository | [liujincheng-ai/InsightAgent](https://github.com/liujincheng-ai/InsightAgent) |
| Community Apps | [dbgpts](https://github.com/eosphoros-ai/dbgpts) |
| GitHub Issues | [Report a bug](https://github.com/liujincheng-ai/InsightAgent/issues) |
| Discussions | [GitHub Discussions](https://github.com/liujincheng-ai/InsightAgent/discussions) |
...
| Paper | [InsightAgent Paper (arXiv)](https://arxiv.org/pdf/2312.17449.pdf) |
| DeepWiki | [InsightAgent DeepWiki](https://deepwiki.com/liujincheng-ai/InsightAgent) |
