...
Create, configure, and manage AI applications in InsightAgent. Apps combine LLMs, tools, knowledge bases, and workflows into reusable configurations.

## App types

| Type | Description |
|---|---|
| **Native App** | Built-in applications included with InsightAgent |
