...
summary: "What is available in the InsightAgent Web UI and where each main feature lives"
read_when:
  - You already started InsightAgent and want to know what to click first
  - You want a quick map of chat, knowledge, dashboard, and app screens
---

# Web UI Overview

InsightAgent ships with a web interface at **[http://localhost:5670](http://localhost:5670)**.
...
- [App Management](/docs/getting-started/web-ui/app-management) — create and manage InsightAgent applications
...
After starting the InsightAgent server, the Web UI is available at:
