...
InsightAgent provides multiple chat modes through its Web UI — each tailored for a different use case.
...
Query your connected databases using natural language. InsightAgent converts your question into SQL, executes it, and presents the results.
...
InsightAgent: [generates SQL, executes, and displays results in a table]
```
...
InsightAgent: [analyzes the file and presents results]
```
