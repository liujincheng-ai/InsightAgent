...
Create data visualizations and reports using natural language. InsightAgent converts your questions into SQL queries and renders the results as interactive charts.
...
2. InsightAgent generates the appropriate SQL query
...
- A database connected to InsightAgent (see [Data Sources](/docs/getting-started/concepts/data-sources))
...
InsightAgent's visualization engine ([GPT-Vis](https://github.com/eosphoros-ai/GPT-Vis)) supports:
...
InsightAgent includes sample data for testing:
