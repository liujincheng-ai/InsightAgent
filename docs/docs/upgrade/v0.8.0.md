...
:::tip
All upgrade SQL scripts are maintained in the repository under [`assets/schema/upgrade/`](https://github.com/liujincheng-ai/InsightAgent/tree/main/assets/schema/upgrade).
:::
...
Restart the InsightAgent service using your preferred start method. Verify that the service is running correctly and the new share-link feature is available.
