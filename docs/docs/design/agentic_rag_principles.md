...
> This document explains how InsightAgent combines Agent + RAG to answer knowledge-base questions, from query to a cited final answer. Intended for product/design readers — no code.
...
Agentic RAG (multi-round)  ← InsightAgent uses this
┌──────────┐    ┌──────────────────────────────────────┐    ┌──────────┐
