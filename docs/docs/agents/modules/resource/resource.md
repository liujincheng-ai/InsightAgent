...
Resources are a bridge for InsightAgent agents to interact with the outside world. They include
...
In following sections, we will introduce most of the resources that can be used in InsightAgent.