...
### Q2:How to change Vector DB Type in InsightAgent.

Update .env file and set VECTOR_STORE_TYPE.

InsightAgent currently support Chroma(Default), Milvus(>2.1), Weaviate, Valkey, OceanBase vector database.
...
```
If you want to support more vector db, you can integrate yourself.[how to integrate](https://liujincheng-ai.github.io/InsightAgent/en/latest/modules/vector.html)
```commandline
#*******************************************************************#
...
<p align="left">
  <img src="https://github.com/liujincheng-ai/InsightAgent/assets/13723926/088d1967-88e3-4f72-9ad7-6c4307baa2f8" width="800px" />
</p>
...
### Q5:Use Mysql, how to use InsightAgent KBQA
