...
title: InsightAgent Now Supports Qwen3 Series Models
authors: fangyinc
tags: [Qwen, Qwen3, LLM]
---

We are thrilled to announce that InsightAgent now supports inference with the Qwen3 series models!
...
## Using Qwen3 in InsightAgent

Please read the [Source Code Deployment](../docs/installation/sourcecode) to learn how to install InsightAgent from source code.
...
To run InsightAgent with the local Qwen3 model. You can provide a configuration file to specify the model path and other parameters.
...
Open your browser and visit `http://localhost:5670` to use the Qwen3 models in InsightAgent.

Enjoy the power of Qwen3 in InsightAgent!
