...
title: InsightAgent Now Supports Meta Llama 3.1 Series Models
authors: fangyinc
tags: [llama, LLM]
---

We are thrilled to announce that InsightAgent now supports inference with the Meta Llama 3.1 series models!
...
## Using Meta Llama 3.1 in InsightAgent
...
Please cd to the InsightAgent root directory:
```bash
cd InsightAgent
```
...
Open your browser and visit `http://localhost:5670` to use the Meta Llama 3.1 models in InsightAgent.

Enjoy the power of Meta Llama 3.1 in InsightAgent!
