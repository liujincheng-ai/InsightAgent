...
const featureGroups = [
  {
    ...
    items: [
      {
        title: 'Overview',
        description: 'Learn what InsightAgent is and how it revolutionizes database interactions with AI.',
        link: '/docs/overview',
        icon: '📖',
      },
      {
        title: 'Getting Started',
        description: 'Get InsightAgent running in minutes with the one-line installer.',
        link: '/docs/installation',
        icon: '🚀',
      },
      {
        title: 'Show Cases',
        description: 'Explore real-world use cases and examples powered by InsightAgent.',
        link: '/docs/use_cases',
        icon: '⚡',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Get started quickly with the InsightAgent CLI.',
...
const quickLinks = [
  { title: 'GitHub', href: 'https://github.com/liujincheng-ai/InsightAgent', icon: '🔗' },
  { title: 'Discord', href: 'https://discord.gg/erwfqcMP', icon: '💬' },
  { title: 'HuggingFace', href: 'https://huggingface.co/eosphoros', icon: '🤗' },
  { title: 'Community', href: 'https://github.com/liujincheng-ai/InsightAgent/discussions', icon: '👥' },
];
...
export default function Home() {
  ...
  const logoSrc = useBaseUrl('img/insightagent_logo.png');

  return (
    <Layout
      title={siteConfig.title}
      description="InsightAgent: Open-Source Agentic AI Data Assistant - Revolutionizing Database Interactions with Private LLM Technology"
    >
      <main className="homepage-main">
        <div className="homepage-hero">
          <div className="homepage-hero-content">
            <img src={logoSrc} alt="InsightAgent Logo" className="homepage-hero-logo" />
