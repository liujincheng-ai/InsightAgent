# Multimodal Support in InsightAgent

InsightAgent supports multimodal capabilities, allowing you to work with various data types such as text, images, and audio. This guide will help you set up and use multimodal features in InsightAgent.
...
### Step 4: Use The Model In InsightAgent

Now, InsightAgent just support image input, and only the `Chat Normal` scenario is supported.
