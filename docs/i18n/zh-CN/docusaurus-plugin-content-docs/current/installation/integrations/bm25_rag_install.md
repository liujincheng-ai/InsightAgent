...
In this example, we will show how to use the Elasticsearch as in InsightAgent RAG Storage. Using a Elasticsearch database to implement RAG can, to some extent, alleviate the uncertainty and interpretability issues brought about by Elasticsearch database retrieval.
...
Set rag storage variables below in `configs/dbgpt-bm25-rag.toml` file, let InsightAgent know how to connect to Elasticsearch.
