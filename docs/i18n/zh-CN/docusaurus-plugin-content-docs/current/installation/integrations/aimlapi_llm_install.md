...
### This section describes how to use the AI/ML API provider with InsightAgent.
...
3. Use the `configs/dbgpt-proxy-aimlapi.toml` configuration when starting InsightAgent.
...
### Or you can use docker/base/Dockerfile to run InsightAgent with AI/ML API:
