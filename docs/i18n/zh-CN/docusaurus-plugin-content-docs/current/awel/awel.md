...
### Example of API-RAG 
You can find [source code](https://github.com/liujincheng-ai/InsightAgent/blob/main/examples/awel/simple_rag_example.py) from `examples/awel/simple_rag_example.py`
```python
