...
在 InsightAgent 中，skill 是一种可复用的能力包，为智能体提供完成某类任务的结构化方式。

相比只依赖自由推理，skill 为特定类型的工作提供了更稳定、更可重复的执行模式。

<img
  src="/img/skill/skill_list_zh.png"
  alt="InsightAgent 技能总览"
...
在 InsightAgent 语境里，skill 不只是“模型知道什么”，而是一个打包好的工作流，帮助智能体决定：
...
按照 InsightAgent 当前 skill-creator 的实践，一个 skill 通常组织为一个小型、自包含的能力包：
