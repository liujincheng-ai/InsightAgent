...
After a period of intensive development, version 0.5.0 has taken over two months to come to fruition. This marks the first stable release that will be maintained over an extended period within the InsightAgent project. Concurrently, the long-term vision for InsightAgent has been officially set: it aims to be an AI native data application development framework utilizing Agentic Workflow Expression Language (AWEL) and agents.
...
In its early releases, the InsightAgent project offered six default use cases, namely:
- [ChatData](https://liujincheng-ai.github.io/InsightAgent/docs/application/started_tutorial/chat_data)
- [ChatExcel](https://liujincheng-ai.github.io/InsightAgent/docs/application/started_tutorial/chat_excel)
- [ChatDB](https://liujincheng-ai.github.io/InsightAgent/docs/application/started_tutorial/chat_db)
- [ChatKnowledge](https://liujincheng-ai.github.io/InsightAgent/docs/application/started_tutorial/chat_knowledge)
- [ChatAgents](https://liujincheng-ai.github.io/InsightAgent/docs/agents)
- [ChatDashboard](https://liujincheng-ai.github.io/InsightAgent/docs/application/started_tutorial/chat_dashboard)
...
1. **Data App**: an intelligent Data application built on InsightAgent.
...
1. Install it from the application repository provided by InsightAgent.
2. Create it yourself. The following describes the simple use of the following two methods. For more detailed use, see InsightAgent following tutorial.
...
Ensure that you first install and deploy InsightAgent.
...
After the installation is successful, restart the InsightAgent service (dynamic hot loading is on the way), refresh the page, and then `AWEL workflow page` see the corresponding workflow.
...
## Appendix
- InsightAgent framework: https://github.com/eosphoros-ai
- Text2SQL fine tuning: https://github.com/eosphoros-ai/DB-GPT-Hub
- InsightAgent-Web : https://github.com/liujincheng-ai/InsightAgent
- official English documentation: https://liujincheng-ai.github.io/InsightAgent/docs/overview
