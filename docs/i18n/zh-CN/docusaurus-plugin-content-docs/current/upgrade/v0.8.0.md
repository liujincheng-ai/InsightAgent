...
:::tip
所有版本升级所需的 SQL 脚本均维护在仓库的 [`assets/schema/upgrade/`](https://github.com/liujincheng-ai/InsightAgent/tree/main/assets/schema/upgrade) 目录下。
:::
...
使用您常用的方式重新启动 InsightAgent 服务。启动后请确认服务运行正常，并验证新的会话分享链接功能是否可用。
