...
### Stop InsightAgent Service

Stop the InsightAgent service according to your start way.

### Upgrade database
Execute the following SQL to upgrade the database.

:::tip
The asset files required for the version upgrade are placed [here](https://github.com/liujincheng-ai/InsightAgent/tree/main/assets/schema/upgrade).
:::
