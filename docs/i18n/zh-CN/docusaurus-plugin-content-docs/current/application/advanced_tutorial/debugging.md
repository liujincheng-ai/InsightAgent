# Debugging
InsightAgent provides a series of tools to help developers troubleshoot and solve some problems they may encounter.

## View Trace Logs With Command

InsightAgent writes some key system runtime information to trace logs. By default, they are located in `logs/dbgpt*.jsonl`.


InsightAgent also provides a command line tool `dbgpt trace` to help analyze these trace logs. You can check the specific usage through the following command:
...
Operation: InsightAgent-Web-Entry (Start: 2023-10-12 03:06:43.180, End: None)
...
Operation: InsightAgent-Web-Entry (Start: 2023-10-12 03:06:43.180, End: 2023-10-12 03:06:43.257)
+-------------------------------------------------------------------------------------------------------------------------------------------+
|                                                             Chat Trace Details                                                            |
+----------------+--------------------------------------------------------------------------------------------------------------------------+
|      Key       |                                                       Value Value                                                        |
...
The output is as follows:
```python
Operation: InsightAgent-Web-Entry (Start: 2023-10-12 03:22:10.592, End: None)
...
Operation: InsightAgent-Web-Entry (Start: 2023-10-12 03:22:10.592, End: 2023-10-12 03:22:10.673)
```
