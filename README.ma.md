# <img src="./assets/LOGO_SMALL.png" alt="ലോഗോ" സ്റ്റൈൽ="ലംബ-അലൈൻ: മധ്യഭാഗം; ഉയരം: 24px;" /> InsightAgent: AWEL ഉം ഏജന്റുമാരുമൊത്തുള്ള AI നേറ്റീവ് ഡാറ്റ ആപ്പ് ഡെവലപ്‌മെന്റ് ഫ്രെയിംവർക്ക്

<p align="left">

<img src="./assets/InsightAgent.png" width="100%" />
</p>

<div align="center">
<p>

<a href="https://github.com/liujincheng-ai/InsightAgent">
<img alt="stars" src="https://img.shields.io/github/stars/liujincheng-ai/InsightAgent?style=social" />
</a>
<a href="https://github.com/liujincheng-ai/InsightAgent">
<img alt="forks" src="https://img.shields.io/github/forks/liujincheng-ai/InsightAgent?style=social" />
</a>
<a href="https://github.com/liujincheng-ai/InsightAgent">
...
<img alt="ലൈസൻസ്: MIT" src="https://img.shields.io/github/license/liujincheng-ai/InsightAgent?style=flat&labelColor=009966&color=009933" />
</a>
<a href="https://github.com/liujincheng-ai/InsightAgent/releases">
      <img alt="റിലീസ് നോട്ടുകൾ" src="https://img.shields.io/github/v/release/liujincheng-ai/InsightAgent?style=flat&labelColor=FF9933&color=FF6633" />
    </a>
    <a href="https://github.com/liujincheng-ai/InsightAgent/issues">
      <img alt="തുറന്ന പ്രശ്നങ്ങൾ" src="https://img.shields.io/github/issues-raw/liujincheng-ai/InsightAgent?style=flat&labelColor=666666&color=333333" />
    </a>
    ...
    <a href="https://medium.com/@dbgpt0506">
      <img alt="മീഡിയം പിന്തുടരുക" src="https://badgen.net/badge/Medium/InsightAgent/333333?icon=medium&labelColor=666666" />
    </a>
    ...
    <a href="https://codespaces.new/liujincheng-ai/InsightAgent">
...
[**രേഖകൾ**](https://liujincheng-ai.github.io/InsightAgent/docs/overview/) | [**ഞങ്ങളെ സമീപിക്കുക**](https://github.com/liujincheng-ai/InsightAgent/blob/main/README.zh.md#%E8%81%94%E7%B3%BB%E6%88%91%E4%BB%AC) | [**സമൂഹം**](https://github.com/liujincheng-ai/InsightAgent/discussions) | [**പേപ്പർ**](https://arxiv.org/pdf/2312.17449.pdf)

</div>

## InsightAgent എന്താണ്?

🤖 **InsightAgent എന്നത് AWEL (Agentic Workflow Expression Language) മറ്റും ഏജന്റുകളും ഉൾപ്പെടുന്ന ഒരു ഓപ്പൺ സോഴ്സ് AI നേറ്റീവ് ഡാറ്റ ആപ്പ് ഡെവലപ്മെന്റ് ഫ്രെയിംവർക്കാണ്**.
...
### ആമുഖം
InsightAgent-യുടെ ആർക്കിടെക്ചർ ഇനിപ്പറയുന്ന ചിത്രത്തിൽ കാണിച്ചിരിക്കുന്നു:

<p align="center">
  <img src="./assets/InsightAgent.png" width="800" />
</p>

കോർ കഴിവുകൾ ഇനിപ്പറയുന്ന ഭാഗങ്ങളെ ഉൾക്കൊള്ളുന്നു:

- **RAG (Retrieval Augmented Generation)**: RAG നിലവിൽ ഏറ്റവും പ്രായോഗികമായി നടപ്പിലാക്കിയതും അത്യാവശ്യമായതുമായ ഡൊമെയ്നാണ്. InsightAgent ഇതിനകം RAG അടിസ്ഥാനമാക്കിയ ഒരു ഫ്രെയിംവർക്ക് നടപ്പിലാക്കിയിട്ടുണ്ട്, ഇത് ഉപയോക്താക്കൾക്ക് InsightAgent-യുടെ RAG കഴിവുകൾ ഉപയോഗിച്ച് അറിവ് അടിസ്ഥാനമാക്കിയ ആപ്ലിക്കേഷനുകൾ നിർമ്മിക്കാൻ അനുവദിക്കുന്നു.

- **GBI (Generative Business Intelligence)**: ജനറേറ്റീവ് BI, InsightAgent പ്രോജക്റ്റിന്റെ കോർ കഴിവുകളിൽ ഒന്നാണ്, എന്റർപ്രൈസ് റിപ്പോർട്ട് അനലിസിസ് മറ്റും ബിസിനസ് ഇൻസൈറ്റുകൾ നിർമ്മിക്കുന്നതിനുള്ള അടിസ്ഥാന ഡാറ്റ ഇന്റലിജൻസ് സാങ്കേതികത നൽകുന്നു.

- **ഫൈൻ-ട്യൂണിംഗ് ഫ്രെയിംവർക്ക്**: മോഡൽ ഫൈൻ-ട്യൂണിംഗ് എന്നത് ഏതൊരു എന്റർപ്രൈസും വർട്ടിക്കൽ മറ്റും നിഷ് ഡൊമെയ്നുകളിൽ നടപ്പിലാക്കേണ്ടത് അനിവാര്യമായ കഴിവാണ്. InsightAgent ഒരു പൂർണ്ണ ഫൈൻ-ട്യൂണിംഗ് ഫ്രെയിംവർക്ക് നൽകുന്നു, ഇത് InsightAgent പ്രോജക്റ്റുമായി തടസ്സമില്ലാതെ സംയോജിപ്പിക്കുന്നു. സമീപകാല ഫൈൻ-ട്യൂണിംഗ് ശ്രമങ്ങളിൽ, Spider ഡാറ്റാസെറ്റ് അടിസ്ഥാനമാക്കി 82.5% അക്യുറസി നിരക്ക് നേടിയിട്ടുണ്ട്.

- **ഡാറ്റ-ഡ്രൈവൻ മൾട്ടി-ഏജന്റുകൾ ഫ്രെയിംവർക്ക്**: InsightAgent ഒരു ഡാറ്റ-ഡ്രൈവൻ സെൽഫ്-ഇവോൾവിംഗ് മൾട്ടി-ഏജന്റുകൾ ഫ്രെയിംവർക്ക് നൽകുന്നു, ഇത് ഡാറ്റയെ അടിസ്ഥാനമാക്കി തുടർച്ചയായി തീരുമാനങ്ങൾ എടുത്ത് നടപ്പിലാക്കാൻ ലക്ഷ്യമിടുന്നു.
...
- **ഡാറ്റ സോഴ്സുകൾ**: വിവിധ ഡാറ്റ സോഴ്സുകൾ സംയോജിപ്പിച്ച് പ്രൊഡക്ഷൻ ബിസിനസ് ഡാറ്റ InsightAgent-യുടെ കോർ കഴിവുകളിലേക്ക് തടസ്സമില്ലാതെ കണക്ട് ചെയ്യുന്നു.
...
- [dbgpts](https://github.com/eosphoros-ai/dbgpts)  dbgpts എന്നത് ഔദ്യോഗിക റിപ്പോസിറ്ററിയാണ്, ഇത് InsightAgent-യിൽ നിർമ്മിച്ച ചില ഡാറ്റ ആപ്പുകൾ, AWEL ഓപ്പറേറ്റർമാർ, AWEL വർക്ക്ഫ്ലോ ടെംപ്ലേറ്റുകൾ മറ്റും ഏജന്റുകൾ ഉൾക്കൊള്ളുന്നു.

#### ഡീപ്വിക്കി
- [InsightAgent](https://deepwiki.com/liujincheng-ai/InsightAgent)
...
- [InsightAgent-Plugins](https://github.com/liujincheng-ai/InsightAgent-Plugins) InsightAgent പ്ലഗിനുകൾ, Auto-GPT പ്ലഗിൻ നേരിട്ട് പ്രവർത്തിപ്പിക്കാൻ കഴിയും
- [GPT-Vis](https://github.com/eosphoros-ai/GPT-Vis) വിഷ്വലൈസേഷൻ പ്രോട്ടോക്കോൾ

### AI-നേറ്റീവ് ഡാറ്റ ആപ്പ്
---
- 🔥🔥🔥 [V0.7.0 റിലീസ് ചെയ്തു | ഒരു കൂട്ടം പ്രധാന അപ്ഗ്രേഡുകൾ](https://liujincheng-ai.github.io/InsightAgent/blog/db-gpt-v070-release)
  - [MCP പ്രോട്ടോക്കോൾ പിന്തുണയ്ക്കുക](https://github.com/liujincheng-ai/InsightAgent/pull/2497)
...
[**ഉപയോഗ ട്യൂട്ടോറിയൽ**](https://liujincheng-ai.github.io/InsightAgent/docs/overview)
- [**ഇൻസ്റ്റാൾ ചെയ്യുക**](https://liujincheng-ai.github.io/InsightAgent/docs/installation)
  - [Docker](https://liujincheng-ai.github.io/InsightAgent/docs/installation/docker)
  - [സോഴ്സ് കോഡ്](https://liujincheng-ai.github.io/InsightAgent/docs/installation/sourcecode)
- [**ക്വിക്ക്‌സ്റ്റാർട്ട്**](https://liujincheng-ai.github.io/InsightAgent/docs/quickstart)
- [**അപ്ലിക്കേഷൻ**](https://liujincheng-ai.github.io/InsightAgent/docs/operation_manual)
  - [ഡെവലപ്‌മെന്റ് ഗൈഡ്](https://liujincheng-ai.github.io/InsightAgent/docs/cookbook/app/data_analysis_app_develop)
  - [അപ്പ് ഉപയോഗം](https://liujincheng-ai.github.io/InsightAgent/docs/application/app_usage)
  - [AWEL ഫ്ലോ ഉപയോഗം](https://liujincheng-ai.github.io/InsightAgent/docs/application/awel_flow_usage)
- [**ഡീബഗ്ഗിംഗ്**](https://liujincheng-ai.github.io/InsightAgent/docs/operation_manual/advanced_tutorial/debugging)
- [**അഡ്വാൻസ്ഡ് ഉപയോഗം**](https://liujincheng-ai.github.io/InsightAgent/docs/application/advanced_tutorial/cli)
  - [SMMF](https://liujincheng-ai.github.io/InsightAgent/docs/application/advanced_tutorial/smmf)
  - [ഫൈൻട്യൂൺ](https://liujincheng-ai.github.io/InsightAgent/docs/application/fine_tuning_manual/dbgpt_hub)
  - [AWEL](https://liujincheng-ai.github.io/InsightAgent/docs/awel/tutorial)
...
- **സ്വകാര്യ ഡൊമെയ്ൻ Q&A & ഡാറ്റാ പ്രോസസ്സിംഗ്**
  ...
  InsightAgent പ്രോജക്റ്റ് നോളജ് ബേസ് നിർമ്മാണം മെച്ചപ്പെടുത്താനും സ്ട്രക്ചർഡ് മറ്റെങ്കിലും അൻസ്ട്രക്ചർഡ് ഡാറ്റയുടെ കാര്യക്ഷമമായ സംഭരണവും വീണ്ടെടുക്കലും സാധ്യമാക്കാനും രൂപകൽപ്പന ചെയ്തിരിക്കുന്ന നിരവധി പ്രവർത്തനങ്ങൾ വാഗ്ദാനം ചെയ്യുന്നു. ഇവയിൽ മൾട്ടിപ്പിൾ ഫയൽ ഫോർമാറ്റുകൾ അപ്‌ലോഡ് ചെയ്യുന്നതിനുള്ള ബിൽറ്റ്-ഇൻ സപ്പോർട്ട്, കസ്റ്റം ഡാറ്റാ എക്സ്ട്രാക്ഷൻ പ്ലഗ്-ഇൻസ് സംയോജിപ്പിക്കാനുള്ള കഴിവ്, മറ്റെങ്കിലും വലിയ അളവിലുള്ള വിവരങ്ങൾ ഫലപ്രദമായി നിയന്ത്രിക്കുന്നതിനുള്ള യൂണിഫൈഡ് വെക്ടർ സംഭരണവും വീണ്ടെടുക്കലും ഉൾപ്പെടുന്നു.

- **മൾട്ടി-ഡാറ്റാ സോഴ്സ് & GBI(ജെനറേറ്റീവ് ബിസിനസ് ഇന്റലിജൻസ്)**

  InsightAgent പ്രോജക്റ്റ് Excel, ഡാറ്റാബേസുകൾ, മറ്റെങ്കിലും ഡാറ്റാ വെയർഹൗസുകൾ എന്നിവയുൾപ്പെടെയുള്ള വൈവിധ്യമാർന്ന ഡാറ്റാ സോഴ്സുകളുമായി സീംലെസ് നാച്ചുറൽ ലാംഗ്വേജ് ഇന്ററാക്ഷൻ സാധ്യമാക്കുന്നു. ഇത് ഈ സോഴ്സുകളിൽ നിന്ന് വിവരങ്ങൾ ചോദ്യം ചെയ്യാനും വീണ്ടെടുക്കാനുമുള്ള പ്രക്രിയയെ ലളിതമാക്കുന്നു, ഉപയോക്താക്കളെ ഇന്റ്യൂട്ടീവ് സംഭാഷണങ്ങളിൽ പങ്കെടുക്കാനും ഇൻസൈറ്റുകൾ നേടാനും പ്രാപ്തരാക്കുന്നു. കൂടാതെ, InsightAgent അനലിറ്റിക്കൽ റിപ്പോർട്ടുകളുടെ ജനറേഷൻ സപ്പോർട്ട് ചെയ്യുന്നു, ഉപയോക്താക്കൾക്ക് മൂല്യവത്തായ ഡാറ്റാ സമ്മറികളും വ്യാഖ്യാനങ്ങളും നൽകുന്നു.
...
- [കൂടുതൽ പിന്തുണയ്ക്കുന്ന LLMs](https://liujincheng-ai.github.io/InsightAgent/docs/modules/smmf)
...
- പിന്തുണയ്ക്കുന്ന ഡാറ്റാസോഴ്സുകൾ
  - [ഡാറ്റാസോഴ്സുകൾ](https://liujincheng-ai.github.io/InsightAgent/docs/modules/connections)

## ഇമേജ്
🌐 [AutoDL ഇമേജ്](https://www.codewithgpu.com/i/liujincheng-ai/InsightAgent/dbgpt)



## സംഭാവന

- പുതിയ സംഭാവനകൾക്കുള്ള വിശദമായ മാർഗ്ഗനിർദ്ദേശങ്ങൾ പരിശോധിക്കാൻ, ദയവായി [സംഭാവന ചെയ്യുന്നതെങ്ങനെ](https://github.com/liujincheng-ai/InsightAgent/blob/main/CONTRIBUTING.md) എന്നതിലേക്ക് പരിശോധിക്കുക

### സംഭാവകരുടെ വാൾ
<a href="https://github.com/liujincheng-ai/InsightAgent/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liujincheng-ai/InsightAgent&max=200" />
</a>
...
## സൈറ്റേഷൻ
InsightAgent-യുടെ മൊത്തം ആർക്കിടെക്ചർ മനസ്സിലാക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെങ്കിൽ, ദയവായി <a href="https://arxiv.org/abs/2312.17449" target="_blank">പേപ്പർ</a> മറ്റെങ്കിലും <a href="https://arxiv.org/abs/2404.10209" target="_blank">പേപ്പർ</a> സൈറ്റ് ചെയ്യുക

ഏജന്റ് ഡെവലപ്‌മെന്റിനായി InsightAgent ഉപയോഗിക്കുന്നതിനെക്കുറിച്ച് പഠിക്കാൻ നിങ്ങൾ ആഗ്രഹിക്കുന്നുവെങ്കിൽ, ദയവായി <a href="https://arxiv.org/abs/2412.13520" target="_blank">പേപ്പർ</a> സൈറ്റ് ചെയ്യുക
```bibtex
...
## കോൺടാക്റ്റ് വിവരം
InsightAgent-യിലേക്ക് സംഭാവന ചെയ്ത എല്ലാവർക്കും നന്ദി! നിങ്ങളുടെ ആശയങ്ങൾ, കോഡ്, അഭിപ്രായങ്ങൾ, മറ്റെങ്കിലും ഇവന്റുകളിലും സോഷ്യൽ പ്ലാറ്റ്ഫോമുകളിലും പങ്കിടുന്നത് InsightAgent-യെ മെച്ചപ്പെടുത്തും.
...
- [Github ഇഷ്യൂകൾ](https://github.com/liujincheng-ai/InsightAgent/issues) ⭐️：GB-DPT ഉപയോഗിക്കുന്നതിനെക്കുറിച്ചുള്ള ചോദ്യങ്ങൾക്ക്, CONTRIBUTING എന്നതിൽ കാണുക.
- [Github ചർച്ചകൾ](https://github.com/liujincheng-ai/InsightAgent/discussions) ⭐️：നിങ്ങളുടെ അനുഭവം അല്ലെങ്കിൽ അദ്വിതീയ ആപ്പുകൾ പങ്കിടുക.
- [ട്വിറ്റർ](https://x.com/DBGPT_AI) ⭐️：ദയവായി ഞങ്ങളോട് സംസാരിക്കാൻ മടിക്കരുത്.


[![സ്റ്റാർ ചരിത്ര ചാർട്ട്](https://api.star-history.com/svg?repos=liujincheng-ai/InsightAgent&type=Date)](https://star-history.com/#liujincheng-ai/InsightAgent)
