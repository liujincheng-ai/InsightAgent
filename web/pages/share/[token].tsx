  ...
  return (
    <>
      <Head>
        <title>
          {firstQuestion
            ? `${firstQuestion.slice(0, 60)}${firstQuestion.length > 60 ? '…' : ''} · InsightAgent 回放`
            : 'InsightAgent 对话回放'}
        </title>
      </Head>
      ...
      <div className='flex flex-col h-screen bg-white dark:bg-[#111217] overflow-hidden'>
        ...
        <div className='flex items-center justify-between px-5 py-2.5 border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-[#1a1b1e] flex-shrink-0'>
          <div className='flex items-center gap-3 min-w-0'>
            {/* Logo / brand */}
            <span className='font-bold text-base text-gray-800 dark:text-white flex-shrink-0'>InsightAgent</span>
