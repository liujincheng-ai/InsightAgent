...
const EXAMPLE_CARDS: ExampleCard[] = [
  {
    id: 'insight_sales_diagnosis',
    icon: '📊',
    title: '华东销售下滑诊断',
    description: '联合销售数据、领域工具与经销商制度生成经营分析报告',
    query:
  ...
  },
  {
    ...
    icon: '📚',
    title: '制度证据查询',
    description: '检索折扣审批要求并返回可追溯的制度章节',
    query: '订单折扣超过 8%、12% 和 15% 时分别需要谁审批？请注明《汽车配件价格与折扣管理办法》4.2 节，并说明禁止事项。',
    fillOnly: true,
  ...
  {
    id: 'insight_customer_loss',
    icon: '⚠️',
    title: '客户流失风险预警',
    description: '识别停止采购或大幅下滑客户并解释预警边界',
    query: '用客户流失分析工具找出华东刹车系统 2026Q2 风险客户，给出风险数量、前三名，并说明为什么结果只能叫风险预警。',
    fillOnly: true,
  ...
  {
    id: 'insight_dealer_health',
    icon: '🩺',
    title: '经销商健康度评估',
    description: '用可解释四维评分确定优先调查对象',
    query: '用经销商健康度工具分析华东 2026Q2 风险最高的经销商、得分、风险等级和扣分项，并说明评分版本边界。',
    fillOnly: true,
              ...
              <div className='w-full max-w-[860px] flex flex-col items-center animate-fade-in-up'>
                <h1 className='text-4xl md:text-5xl font-serif text-gray-900 dark:text-gray-100 mb-4 text-center flex items-center gap-4'>
                  <div className='w-12 h-12 rounded-xl bg-white dark:bg-[#1a1b1e] shadow-md flex items-center justify-center flex-shrink-0'>
                    <Image src='/LOGO_SMALL.png' alt='InsightAgent' width={32} height={32} className='object-contain' />
                  </div>
                  InsightAgent
                </h1>

                <p className='text-sm md:text-base text-gray-400 dark:text-gray-500 tracking-[0.2em] font-light mb-10'>
                  企业经营数据与知识协同分析智能体 · 汽车配件销售经营分析场景
                </p>
