export const CommonEn = {
  ...
  data_center_desc:
    'InsightAgent also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  home_title: 'InsightAgent AI Data Assistant',
  ...
  'request.error.network':
    'Cannot connect to InsightAgent service: network unreachable (possibly CORS restriction or service not running). Please check cors_allowed_origins config and whether the service is up.',
