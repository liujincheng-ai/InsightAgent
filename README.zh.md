# <img src="./assets/LOGO_SMALL.png" alt="Logo" style="vertical-align: middle; height: 24px;" /> InsightAgent：开源 Agentic AI 数据分析智能助手
...
[**文档**](https://liujincheng-ai.github.io/InsightAgent/docs/overview/) | [**联系团队**](https://github.com/liujincheng-ai/InsightAgent/blob/main/README.zh.md#%E8%81%94%E7%B3%BB%E6%88%91%E4%BB%AC) | [**社区**](https://github.com/liujincheng-ai/InsightAgent/discussions) | [**Paper**](https://arxiv.org/pdf/2312.17449.pdf)
...
InsightAgent 是一个开源的 **Agentic AI 数据分析智能助手**，面向下一代 **AI + Data** 产品形态。
...
InsightAgent 不只是一个助手界面，它同时也是一个平台，用于构建 **AI Native 数据智能体、工作流与应用**，底层支持 agents、AWEL、RAG 与多模型能力。
...
你可以通过一键安装脚本在几分钟内启动 InsightAgent（macOS / Linux）：

```bash
curl -fsSL https://raw.githubusercontent.com/liujincheng-ai/InsightAgent/main/scripts/install/install.sh | bash
```

也可以直接指定 profile 和 API Key：

```bash
curl -fsSL https://raw.githubusercontent.com/liujincheng-ai/InsightAgent/main/scripts/install/install.sh \
...
如果你已经有本地 InsightAgent 仓库，也可以直接复用当前仓库，跳过 `~/.dbgpt/InsightAgent` 的重复 clone：
...
```bash
cd ~/.dbgpt/InsightAgent && uv run dbgpt start webserver --profile <profile>
```
...
> **想先审阅安装脚本再执行？**
> ```bash
> curl -fsSL https://raw.githubusercontent.com/liujincheng-ai/InsightAgent/main/scripts/install/install.sh -o install.sh
> less install.sh
...
从 PyPI 安装 InsightAgent，一条命令即可启动，无需克隆源码仓库。
...
InsightAgent 希望帮助开发者与企业共同构建这样的未来。
...
更加详细的贡献指南请参考[如何贡献](https://github.com/liujincheng-ai/InsightAgent/blob/main/CONTRIBUTING.md)。
...
## 引用
如果您发现`InsightAgent`对您的研究或开发有用，请引用以下论文，其中：

如果您想了解InsightAgent整体架构，请引用<a href="https://arxiv.org/abs/2312.17449" target="_blank">论文</a>和<a href="https://arxiv.org/abs/2404.10209" target="_blank">论文</a>

如果您想了解使用InsightAgent进行Agent开发相关的内容，请引用<a href="https://arxiv.org/abs/2412.13520" target="_blank">论文</a>
