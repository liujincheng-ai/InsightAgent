...
class CodeGraphStore:
    ...
    def _vertices_to_rows(self, knowledge_id: str, graph: MemoryGraph) -> List[Dict]:
        ...
        InsightAgent's RepoGraphBuilder stores props like:
        ...
        for vertex in graph.vertices():
            ...
            row = {
                "vid": vertex.vid,
                "name": vertex.name,
                # Map "type" prop to node_type column (InsightAgent uses "type")
    ...
    def _edges_to_rows(self, knowledge_id: str, graph: MemoryGraph) -> List[Dict]:
        ...
        InsightAgent's RepoGraphBuilder stores edge props like:
    ...
    def _entity_to_vertex(self, entity: CodeGraphVertexEntity) -> Vertex:
        ...
        Uses "type" key (matching InsightAgent's RepoGraphBuilder convention)
        ...
        # Add dedicated columns back to props using InsightAgent convention
