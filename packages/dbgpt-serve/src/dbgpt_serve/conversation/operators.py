...
class ServePreChatHistoryLoadOperator(PreChatHistoryLoadOperator):
    """Pre-chat history load operator for InsightAgent serve component
...
class DefaultServePreChatHistoryLoadOperator(ServePreChatHistoryLoadOperator):
    """Default pre-chat history load operator for InsightAgent serve component
    ...
    metadata = ViewMetadata(
        ...
        description=_(
            ...
            "It is the default storage of InsightAgent"
        ),
        parameters=[],
        inputs=[
            IOField.build_from(
