"""User-level configuration management for InsightAgent CLI.
...
# need to be readable only by the owning user. The InsightAgent home directory is
...
def _render_profile_toml(
    ...
    lines = [
        f"# InsightAgent configuration — profile: {spec.name}",
