...
Question: Introduce TuGraph and InsightAgent separately.
Return:
{{"category": "Freestyle Question", "rewritten_question": "Query the entity named TuGraph and the entity named InsightAgent, then return two-hop sub-graphs centered on them.", "entities": ["TuGraph", "DBGPT"], "relations": []}}
---------------------
Text: {text}
Return:
