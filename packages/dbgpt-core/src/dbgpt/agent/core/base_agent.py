...
class ConversableAgent(Role, Agent):
    ...
    def _init_tool_result_storage(self, config: ContextBudgetConfig) -> None:
        ...
        from .context.storage import ToolResultBudgetConfig, ToolResultStorage
        ...
        storage = ToolResultStorage(
            ...
            config=ToolResultBudgetConfig(
                default_result_size=config.tool_result_threshold,
                turn_budget=config.turn_result_budget,
