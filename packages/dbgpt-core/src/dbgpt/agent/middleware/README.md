# Agent Middleware System for InsightAgent

This module implements a middleware system for InsightAgent agents, inspired by deepagents' AgentMiddleware pattern.
...
| Feature | DeepAgents | InsightAgent (New) |
|---------|-------------|----------------|
...
This module is part of InsightAgent and follows the same license.
