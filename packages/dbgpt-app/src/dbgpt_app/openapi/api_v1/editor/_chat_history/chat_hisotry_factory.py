...
class ChatHistory:
    ...
    def _check_store_type(self, store_type: str):
        ...
        if store_type == "duckdb":
            link1 = (
                "https://liujincheng-ai.github.io/InsightAgent/docs/latest/faq/install#q6-how-to-migrate-meta"
                "-table-chat_history-and-connect_config-from-duckdb-to-sqlite"
            )
            link2 = (
                "https://liujincheng-ai.github.io/InsightAgent/docs/latest/faq/install/#q7-how-to-migrate-"
