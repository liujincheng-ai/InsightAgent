...
# Matches the tool-result wrapper {"chunks": [...]} that InsightAgent tools return.
...
You are a InsightAgent sub-agent executing ONE focused sub-task delegated by a lead
