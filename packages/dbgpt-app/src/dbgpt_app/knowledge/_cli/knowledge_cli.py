...
def load(
    ...
    """Load your local documents to InsightAgent"""
...
def delete(space_name: str, doc_name: str, y: bool):
    ...
    from dbgpt_app.knowledge._cli.knowledge_client import knowledge_delete
...
def list(
    ...
    from dbgpt_app.knowledge._cli.knowledge_client import knowledge_list
