...
def initialize_sandbox(
    ...
    if app:
        ...
        app = FastAPI(
            title="InsightAgent Sandbox API",
            description="Secure sandbox execution environment for InsightAgent Agent",
            version="0.7.3",
        )
        ...
        @app.get("/")
        async def root():
            return {"message": "InsightAgent Sandbox API is running"}
