...
(liujincheng-ai/InsightAgent#github_repo)
...
(TuGraph-family/tugraph-db#common_developer#liujincheng-ai/InsightAgent#common_developer count 6)
(liujincheng-ai/InsightAgent#belong_to#eosphoros-ai#belong_to)
...
Relationships:
(liujincheng-ai/InsightAgent#common_developer#chatchat-space/Langchain-Chatchat#common_developer count 82)
(liujincheng-ai/InsightAgent#common_developer#hiyouga/LLaMA-Factory#common_developer count 45)
(liujincheng-ai/InsightAgent#common_developer#lm-sys/FastChat#common_developer count 39)
(liujincheng-ai/InsightAgent#common_developer#langchain-ai/langchain#common_developer count 37)
(liujincheng-ai/InsightAgent#common_developer#eosphoros-ai/DB-GPT-Hub#common_developer count 37)
(liujincheng-ai/InsightAgent#common_developer#THUDM/ChatGLM-6B#common_developer count 31)
(liujincheng-ai/InsightAgent#common_developer#langgenius/dify#common_developer count 30)
(liujincheng-ai/InsightAgent#common_developer#vllm-project/vllm#common_developer count 27)
(liujincheng-ai/InsightAgent#common_developer#QwenLM/Qwen#common_developer count 26)
(liujincheng-ai/InsightAgent#common_developer#PaddlePaddle/PaddleOCR#common_developer count 24)
...
# InsightAgent简介
InsightAgent是一个开源的AI原生数据应用开发框架(AI Native Data App Development framework with AWEL(Agentic Workflow Expression Language) and Agents)。目的是构建大模型领域的基础设施，通过开发多模型管理(SMMF)、Text2SQL效果优化、RAG框架以及优化、Multi-Agents框架协作、AWEL(智能体工作流编排)等多种技术能力，让围绕数据库构建大模型应用更简单，更方便。