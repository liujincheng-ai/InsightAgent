...
async def main():
    ...
    try:
        ...
        await user_proxy.initiate_chat(
            recipient=manager,
            reviewer=user_proxy,
            message="Obtain simple information about issues in the repository 'liujincheng-ai/InsightAgent' in the past three days and analyze the data. Create a Markdown table grouped by day and status.",
